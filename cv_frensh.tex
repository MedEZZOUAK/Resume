...
\cventry
  ...
  {Août 2025 -- Présent (CDI)}
  {
    \begin{cvitems}
      ...
      \item {Participation à des réunions client afin de clarifier les besoins fonctionnels et de proposer des solutions techniques adaptées.}
    \end{cvitems}
  }
